...
class VQAExtractor(OperatorABC):
    ...
    def run(self, storage: DataFlowStorage,
            ...
            default_output_dir: str = "../vqa_output",
            default_fallback_subject: str = "math") -> list:
        ...
        for idx, row in dataframe.iterrows():
            ...
            subject = row.get(subject_key, default_subject)
            output_root = row.get(output_dir_key, default_output_dir)
        ...
        for idx, input_json_path in enumerate(json_paths):
            subject = subjects[idx] if idx < len(subjects) else subjects[0] if subjects else default_fallback_subject
